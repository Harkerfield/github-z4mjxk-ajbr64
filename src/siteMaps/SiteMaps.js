...
import iconGreenCrossHair from '../components/openLayers/iconGreenCrossHair.svg';
...
export default function SiteMaps() {
  ...
  console.log('test', iconGreenCrossHair());
  ...
  //...
  //I want to have a column where it shows an emitter or another object such as a tel
